...
(function (l) {
    ...
    u.defaults = {
        ...
        oLanguage: {
            oAria: {
                sSortAscending: ": Sắp xếp theo chiều giảm dần",
                sSortDescending: ": Sắp xếp theo chiều tăng dần"
            },
            oPaginate: {
                sFirst: "Đầu", sLast: "Cuối",
                sNext: "tiếp theo", sPrevious: "về trước"
            },
            sEmptyTable: "Danh sách không có dữ liệu",
            sInfo: "Hiển thị _START_ đến _END_ trên tổng số _TOTAL_ phần tử",
            sInfoEmpty: "Hiển thị 0 đến 0 trên tổng số 0 phần tử",
            sInfoFiltered: "(Đã lọc từ _MAX_ tổng số phần tử)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Hiển thị _MENU_ phẩn tử",
            sLoadingRecords: "Đang tải...",
            sProcessing: "Đang xử lý...",
            sSearch: "Tìm kiếm:",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "không phần tử nào được khớp với kết quả tìm kiếm"
        },
